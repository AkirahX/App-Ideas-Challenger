...
App for the challenger [App Ideas](https://github.com/florinpop17/app-ideas)

I created a simple terminal app using [NodeJs](https://nodejs.org/en/) with [Readline](https://nodejs.org/api/readline.html)
